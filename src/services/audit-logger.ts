 ...
 * Returns a parameterized query with placeholders to prevent SQL injection.
 */
export function buildAuditQuery(userId: string, fromDate?: string): { text: string; params: string[] } {
