 ...
 *
 * Returns a parameterized query object with placeholders ($1, $2, ...)
 * to prevent SQL injection. The caller must pass `params` to the
 * database driver (e.g., pg client) alongside the query text.
 */
